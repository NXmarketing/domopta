            ...
            <div class="tovar content__tovar">
                ...
                <div class="tovar-right">
                    ...
                    <?php if (!Yii::$app->user->isGuest && $model->flag == 1 && Yii::$app->user->identity->profile->type) : ?>
                        <?php if (trim($model->color) != '') : ?>
                            <div class="tovar__help">Укажите необходимое количество товара (при наличии различных цветов для каждого), затем нажмите кнопку "Добавить в корзину", и весь выбранный Вами товар попадет в Корзину.</div>
                        <?php endif; ?>
                    <?php else : ?>
                        ...
                        <?php else : ?>
                            <div class="tovar__help">
                                <?php if ($model->flag == 1) : ?>
                                    ДЛЯ ЗАКАЗА ТОВАРОВ ВАМ НЕОБХОДИМО ПРОЙТИ ПОЛНУЮ <a href="/reg/full" class="reg-link" id="reg2">РЕГИСТРАЦИЮ</a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
