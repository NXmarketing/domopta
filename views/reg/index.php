					...
					<div class="register-left">
						<div class="register__form">
							...
							<div class="register__row-radio">
								...
								<div class="radio">
									<?php echo Html::activeRadioList($profile, 'type', [
									        '1' => 'ПРЕДПРИНИМАТЕЛИ, ИП (ОПТОВЫЕ ЦЕНЫ)<span class="icon-help icon-help1">
                                        <svg class="icon-help__svg">
                                            <use xlink:href="/img/sprite-sheet.svg#qustion"/>
                                        </svg>
                                        <span class="help">
                                            <span class="help__text">'.Yii::$app->settings->get('Settings.hint1').'</span></span>',
                                        '3' => 'ЮРИДИЧЕСКИЕ ЛИЦА, ООО (ОПТОВЫЕ ЦЕНЫ)<span class="icon-help icon-help2">
                                        <svg class="icon-help__svg">
                                            <use xlink:href="/img/sprite-sheet.svg#qustion"/>
                                        </svg>
                                        <span class="help">
                                            <span class="help__text">'.Yii::$app->settings->get('Settings.hint3').'</span></span>',
                                        '2' => 'ФИЗИЧЕСКИЕ ЛИЦА (МЕЛКООПТОВЫЕ ЦЕНЫ)<span class="icon-help icon-help1">
                                        <svg class="icon-help__svg">
                                            <use xlink:href="/img/sprite-sheet.svg#qustion"/>
                                        </svg>
                                        <span class="help">
                                            <span class="help__text">'.Yii::$app->settings->get('Settings.hint2').'</span></span>'], ['encode' => false]) ?>
									<?php if ($err = $profile->getErrors('type')): ?>
							...
							<div class="register__row">
								...
								<div class="register__row" id="reg_inn">
